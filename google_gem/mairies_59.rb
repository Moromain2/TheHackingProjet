...
require 'nokogiri'
require 'open-uri'
NORD_URL = "http://www.annuaire-des-mairies.com/nord.html"
...
#Coller la clé
$worksheet = session.spreadsheet_by_key("12uq3o9HhFBjQENLUqKE6xvTZpftL1bQMVsAMLMSL7SA").worksheets[0]
...
def get_all_the_urls_of_nord_townhalls(url)
	...
	page.xpath('//table/tr[2]/td/table/tr/td/p/a').each do |town|
		...
		url = "http://annuaire-des-mairies.com/59/#{town_name}.html"
...
get_all_the_urls_of_nord_townhalls(NORD_URL)
